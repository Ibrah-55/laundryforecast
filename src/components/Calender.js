  ...
  <div class="container px-5 py-5 mx-auto flex flex-wrap">
    ...
    <div class="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
      ...
      <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        ...
        <svg aria-hidden="true" focusable="false" data-prefix="fas" class="w-10 h-8 text-center mr-2" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
    ...
    <div class="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
      ...
      <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        <div class="flex-shrink-0 w-24 h-24 bg-indigo-100 text-indigo-500 rounded-full inline-flex items-center justify-center">
        <svg aria-hidden="true" focusable="false" data-prefix="fas" class="w-10 h-8 text-center mr-2" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
    ...
    <div class="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
      ...
      <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        <div class="flex-shrink-0 w-24 h-24 bg-indigo-100 text-indigo-500 rounded-full inline-flex items-center justify-center">
        <svg aria-hidden="true" focusable="false" data-prefix="fas" class="w-10 h-8 text-center mr-2" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
