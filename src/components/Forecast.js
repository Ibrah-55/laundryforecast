...
const Forecast = () => {
  ...
  <body className="font-mono lazy  bg-repeat-round bg-[url('https://i.dailymail.co.uk/1s/2022/04/30/22/57249309-10771333-image-a-92_1651355735593.jpg')] h-screen ">
          <div className="container mx-auto">
              <div className="flex justify-center items-center px-6 my-12">
                  <div className="w-full xl:w-3/4 lg:w-11/12 flex">
                      
                      <div className="w-3/4 bg-green-50 h-screen p-5 rounded-lg lg:rounded-l-none">
    ...
    Use current Position
          ...
          <div className="flex items-center justify-center">
            ...
            <ul>
            <h2 className="flex items-center justify-center text-blue-700">{forecast.city.name}</h2>
